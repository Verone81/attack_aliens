...
def afficher_score(fenetre, score):
    ...
    """
    blanc = (255, 255, 255)
    police = pygame.font.Font("polices/Kanit_Regular.ttf", 36)
...
def afficher_game_over(fenetre, largeur_fenetre, hauteur_fenetre, point):
    ...
    police = pygame.font.Font("polices/BebasNeue_Regular.ttf", 74)
    police2 = pygame.font.Font("polices/Kanit_Regular.ttf", 25)
